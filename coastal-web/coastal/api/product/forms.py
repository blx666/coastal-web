...
class ProductAddForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if self.cleaned_data.get('category') and self.cleaned_data.get('category').id == product_defs.CATEGORY_ADVENTURE:
    ...
    def clean_exp_end_time(self):
        ...
        if exp_end_time is not None and exp_end_time.hour == 0:
